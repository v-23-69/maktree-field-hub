-- ============================================================
-- COMPLETE FIX: Tour Program, Strike Reports, Holidays
-- Run this entire script in Supabase SQL Editor in one go.
-- ============================================================

-- ============================================================
-- STEP 1: Grant base table permissions to authenticated role
-- Without these, RLS policies cannot even evaluate.
-- ============================================================

GRANT USAGE ON SCHEMA public TO authenticated;
GRANT SELECT ON public.users TO authenticated;
GRANT SELECT ON public.mr_manager_map TO authenticated;
...
GRANT UPDATE (ptr) ON public.products TO authenticated;
...
-- ============================================================
-- STEP 4: tour_programs RLS policies
-- ============================================================
...
-- ============================================================
-- STEP 5: tour_program_entries RLS policies
-- ============================================================
...
DROP POLICY IF EXISTS "mr_holidays_mr_read" ON public.mr_holidays;
DROP POLICY IF EXISTS "mr_holidays_manager_read" ON public.mr_holidays;
DROP POLICY IF EXISTS "mr_holidays_admin_read" ON public.mr_holidays;

CREATE POLICY mr_holidays_select_all ON public.mr_holidays
FOR SELECT TO authenticated USING (true);

-- ============================================================
-- STEP 7: holidays RLS (readable by everyone)
-- ============================================================

DROP POLICY IF EXISTS holidays_select_all ON public.holidays;
DROP POLICY IF EXISTS "holidays_admin_all" ON public.holidays;
DROP POLICY IF EXISTS "holidays_mr_read" ON public.holidays;
DROP POLICY IF EXISTS "holidays_manager_read" ON public.holidays;

CREATE POLICY holidays_select_all ON public.holidays
FOR SELECT TO authenticated USING (true);

-- ============================================================
-- STEP 8: strike_reports RLS
-- ============================================================
...
-- ============================================================
-- STEP 11: Verify everything works (diagnostic)
-- ============================================================

SELECT 'GRANTS CHECK' AS check_type,
  has_table_privilege('authenticated', 'public.users', 'SELECT') AS users_select,
  has_table_privilege('authenticated', 'public.tour_programs', 'SELECT') AS tp_select,
  has_table_privilege('authenticated', 'public.tour_programs', 'INSERT') AS tp_insert,
  has_table_privilege('authenticated', 'public.tour_program_entries', 'SELECT') AS tpe_select,
  has_table_privilege('authenticated', 'public.tour_program_entries', 'INSERT') AS tpe_insert,
  has_table_privilege('authenticated', 'public.mr_holidays', 'SELECT') AS mh_select,
  has_table_privilege('authenticated', 'public.holidays', 'SELECT') AS hol_select,
  has_table_privilege('authenticated', 'public.strike_reports', 'SELECT') AS sr_select,
  has_table_privilege('authenticated', 'public.mr_manager_map', 'SELECT') AS mmm_select;
